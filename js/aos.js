gsap.from('.img-thumbnail', { duration: 2, rotationX: 360 });
      ...
      gsap.to('.lead', { delay: 1.5, duration: 2.15, text: '<i class="bi bi-person-fill"></i> Students | <i class="bi bi-cpu-fill"></i>  Programmer | <i class="bi bi-joystick"></i> Minecraft Players' });
